...
public class DESUtilApp {
    ...
    public DESUtilApp() throws Exception {
        this(strDefaultKey);
    }

    public DESUtilApp(String strKey) throws Exception {
        if (strKey == null)
            return;
    ...
    public static void main(String[] args) {
        try {
            String test = "002200391234567890";
            ...
            DESUtilApp des = new DESUtilApp(key);
            System.out.println("加密前的字符：" + test);
            System.out.println("加密后的字符：" + DESUtilApp.encode(key, test+key));
